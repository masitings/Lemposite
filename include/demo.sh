...
DEMO() {
  ...
  [ "${IPADDR_COUNTRY}"x == "CN"x ] && /bin/cp ${lemposite_dir}/config/index_cn.html ${wwwroot_dir}/default/index.html || /bin/cp ${lemposite_dir}/config/index.html ${wwwroot_dir}/default
